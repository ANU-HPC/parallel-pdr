...
def extraSettings(filename):
    ignoreKeys = ["obligation_rescheduling", "project_last", "complete_nonfinal", "decomposed", "report_plan", "dagster", "mpi_nodes", "interleaved_layers", "interleaved_layers", "transitions_to_num_workers", "evaluation_mode", "nondeterministic"]
    expectedNum = 16

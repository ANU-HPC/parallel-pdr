(define (domain appn-pls)
 ...
 (:action breaker-close-unexplained_breaker_x1_x2_obs2559_n0_n1
  ...
  :effect (and (breaker-state-is-closed_breaker_x1_x2) (fault-count-2_count-as-fault_breaker_x1_x2_n1) (observed_obs2559) (line-iso-state-may-have-changed_line_x19_x20_obs2559) (not (breaker-state-is-open_breaker_x1_x2)) (not (fault-count-2_count-as-fault_breaker_x1_x2_n0)) (not (dominates-2_hyp9_count-as-fault_breaker_x1_x2)) (not (dominates-2_hyp8_count-as-fault_breaker_x1_x2)) (not (dominates-2_hyp5_count-as-fault_breaker_x1_x2)) (not (dominates-2_hyp4_count-as-fault_breaker_x1_x2)) (not (dominates-2_hyp1_count-as-fault_breaker_x1_x2)) (not (pending_obs2559))))

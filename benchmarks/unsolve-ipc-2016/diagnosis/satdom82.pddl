(define (domain appn-pls)
 ...
 (:action bus-mw-goes-to-zero-unexplained_bus_x4_obs8887_n0_n1
  ...
  :effect (and (observed_obs8887) (fault-count-2_count-as-fault_bus_x4_n1) (not (pending_obs8887)) (not (fault-count-2_count-as-fault_bus_x4_n0)) (not (dominates-2_hyp3_count-as-fault_bus_x4))))

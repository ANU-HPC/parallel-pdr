(define (domain appn-pls)
 ...
 (:action breaker-open-unexplained_breaker_x9_x10_obs640_n0_n1
  ...
  :effect (and (breaker-state-is-open_breaker_x9_x10) (observed_obs640) (line-iso-state-may-have-changed_line_x31_x32_obs640) (not (breaker-state-is-closed_breaker_x9_x10)) (not (pending_obs640)) (not (fault-count-2_count-as-fault_breaker_x9_x10_n0)) (not (dominates-2_hyp3_count-as-fault_breaker_x9_x10))))
 (:action breaker-open-unexplained_breaker_x11_x12_obs641_n0_n1
  ...
  :effect (and (breaker-state-is-open_breaker_x11_x12) (observed_obs641) (line-iso-state-may-have-changed_line_x27_x28_obs641) (not (breaker-state-is-closed_breaker_x11_x12)) (not (pending_obs641)) (not (fault-count-2_count-as-fault_breaker_x11_x12_n0)) (not (dominates-2_hyp1_count-as-fault_breaker_x11_x12))))
 ...
 (:action line-iso-trip-first-breaker-simple-trip-1_line_x27_x28_breaker_x11_x12_breaker_x11_x12_obs641_n0_n1
  ...
  :effect (and (breaker-state-is-open_breaker_x11_x12) (observed_obs641) (line-iso-trip-in-progress_line_x27_x28_obs641) (not (breaker-state-is-closed_breaker_x11_x12)) (not (pending_obs641)) (not (fault-count-2_count-as-fault_line_x27_x28_n0)) (not (not_line-iso-trip-in-progress_line_x27_x28_obs641)) (not (dominates-2_hyp3_count-as-fault_line_x27_x28)) (not (dominates-2_hyp2_count-as-fault_line_x27_x28))))
 ...
 (:action line-voltage-goes-to-zero-unexplained-1_line_x27_x28_obs642_n0_n1
  ...
  :effect (and (observed_obs642) (not (fault-count-2_count-as-fault_line_x27_x28_n0)) (not (dominates-2_hyp3_count-as-fault_line_x27_x28)) (not (dominates-2_hyp2_count-as-fault_line_x27_x28)) (not (pending_obs642))))

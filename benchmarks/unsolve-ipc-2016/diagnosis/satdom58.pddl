(define (domain appn-pls)
 ...
 (:action set_goal_4_constraint1
  ...
  :effect (and (achieved_constraint1) (not (not_at_end_constraint1))))
 (:action set_goal_10_constraint1
  :parameters ()

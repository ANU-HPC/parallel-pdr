(define (domain appn-pls)
 ...
 (:action breaker-open-unexplained_breaker_x1_x2_obs8873_n0_n1
  ...
  :effect (and (observed_obs8873) (fault-count-2_count-as-fault_breaker_x1_x2_n1) (not (breaker-state-is-closed_breaker_x1_x2)) (not (pending_obs8873)) (not (fault-count-2_count-as-fault_breaker_x1_x2_n0)) (not (dominates-2_hyp3_count-as-fault_breaker_x1_x2)) (not (dominates-2_hyp1_count-as-fault_breaker_x1_x2))))
 ...
 (:action generator-begin-shutdown_generator_x2_1_n3_n4
  ...
  :effect (and (generator-status-is-shutting-down_generator_x2_1) (fault-count-2_count-as-fault_generator_x2_1_n4) (not (generator-status-is-on_generator_x2_1)) (not (fault-count-2_count-as-fault_generator_x2_1_n3)) (not (dominates-2_hyp3_count-as-fault_generator_x2_1)) (not (dominates-2_hyp1_count-as-fault_generator_x2_1))))
 ...
 (:action generator-begin-startup_generator_x2_1_n3_n4
  ...
  :effect (and (fault-count-2_count-as-fault_generator_x2_1_n4) (generator-status-is-starting-up_generator_x2_1) (not (generator-status-is-on_generator_x2_1)) (not (fault-count-2_count-as-fault_generator_x2_1_n3)) (not (dominates-2_hyp3_count-as-fault_generator_x2_1)) (not (dominates-2_hyp1_count-as-fault_generator_x2_1))))
 ...
 (:action generator-runback-alarm_generator_x2_1_obs8865_n3_n4
  ...
  :effect (and (fault-count-2_count-as-fault_generator_x2_1_n4) (observed_obs8865) (not (fault-count-2_count-as-fault_generator_x2_1_n3)) (not (dominates-2_hyp3_count-as-fault_generator_x2_1)) (not (dominates-2_hyp1_count-as-fault_generator_x2_1)) (not (pending_obs8865))))
 ...
 (:action generator-runback-alarm_generator_x2_1_obs8889_n3_n4
  ...
  :effect (and (fault-count-2_count-as-fault_generator_x2_1_n4) (observed_obs8889) (not (fault-count-2_count-as-fault_generator_x2_1_n3)) (not (dominates-2_hyp3_count-as-fault_generator_x2_1)) (not (dominates-2_hyp1_count-as-fault_generator_x2_1)) (not (pending_obs8889))))
 ...
 (:action generator-runback-alarm-reset_generator_x2_1_obs8870_n3_n4
  ...
  :effect (and (fault-count-2_count-as-fault_generator_x2_1_n4) (observed_obs8870) (not (fault-count-2_count-as-fault_generator_x2_1_n3)) (not (dominates-2_hyp3_count-as-fault_generator_x2_1)) (not (dominates-2_hyp1_count-as-fault_generator_x2_1)) (not (pending_obs8870))))
 ...
 (:action generator-runback-alarm-reset_generator_x2_1_obs8891_n3_n4
  ...
  :effect (and (fault-count-2_count-as-fault_generator_x2_1_n4) (observed_obs8891) (not (fault-count-2_count-as-fault_generator_x2_1_n3)) (not (dominates-2_hyp3_count-as-fault_generator_x2_1)) (not (dominates-2_hyp1_count-as-fault_generator_x2_1)) (not (pending_obs8891))))
 ...
 (:action set_goal_33_constraint0
  :parameters ()

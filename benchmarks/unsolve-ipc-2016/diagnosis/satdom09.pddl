(define (domain appn-pls)
 ...
 (:action line-voltage-goes-to-zero-unexplained-1_line_x15_x16_obs1409_n0_n1
  ...
  :effect (and (fault-count-2_count-as-fault_line_x15_x16_n1) (observed_obs1409) (not (fault-count-2_count-as-fault_line_x15_x16_n0)) (not (dominates-2_hyp3_count-as-fault_line_x15_x16)) (not (pending_obs1409))))

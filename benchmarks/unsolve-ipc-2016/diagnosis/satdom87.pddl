(define (domain appn-pls)
 ...
 (:action breaker-open-unexplained_breaker_x19_x20_obs2666_n0_n1
  ...
  :effect (and (breaker-state-is-open_breaker_x19_x20) (observed_obs2666) (line-iso-state-may-have-changed_line_x32_x33_obs2666) (not (breaker-state-is-closed_breaker_x19_x20)) (not (pending_obs2666)) (not (fault-count-2_count-as-fault_breaker_x19_x20_n0)) (not (dominates-2_hyp1_count-as-fault_breaker_x19_x20))))

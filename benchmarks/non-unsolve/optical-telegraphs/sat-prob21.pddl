(define (problem opt-cycle-22)
  ...
  (:init
   ...
   (station-write-queue stn-22-dn stn-1-up-recv)
   (station-ctl-queue   stn-1-up stn-1-ctl)
   (station-read-queue  stn-1-up stn-1-up-recv)
   (station-write-queue stn-1-up stn-22-dn-recv)
  ...
  (:goal (and
 (blocked stn-1-dn) (blocked stn-2-dn) (blocked stn-3-dn) (blocked stn-4-dn) (blocked stn-5-dn) (blocked stn-6-dn) (blocked stn-7-dn) (blocked stn-8-dn) (blocked stn-9-dn) (blocked stn-10-dn) (blocked stn-11-dn) (blocked stn-12-dn) (blocked stn-13-dn) (blocked stn-14-dn) (blocked stn-15-dn) (blocked stn-16-dn) (blocked stn-17-dn) (blocked stn-18-dn) (blocked stn-19-dn) (blocked stn-20-dn) (blocked stn-21-dn) (blocked stn-22-dn) (blocked stn-1-up) (blocked stn-2-up) (blocked stn-3-up) (blocked stn-4-up) (blocked stn-5-up) (blocked stn-6-up) (blocked stn-7-up) (blocked stn-8-up) (blocked stn-9-up) (blocked stn-10-up) (blocked stn-11-up) (blocked stn-12-up) (blocked stn-13-up) (blocked stn-14-up) (blocked stn-15-up) (blocked stn-16-up) (blocked stn-17-up) (blocked stn-18-up) (blocked stn-19-up) (blocked stn-20-up) (blocked stn-21-up) (blocked stn-22-up)))
 )

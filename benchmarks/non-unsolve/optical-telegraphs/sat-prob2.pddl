(define (problem opt-cycle-3)
  ...
  (:init
   ...
   (station-write-queue stn-3-dn stn-1-up-recv)
   (station-ctl-queue   stn-1-up stn-1-ctl)
   (station-read-queue  stn-1-up stn-1-up-recv)
   (station-write-queue stn-1-up stn-3-dn-recv)
  ...
  (:goal (and
 (blocked stn-1-dn) (blocked stn-2-dn) (blocked stn-3-dn) (blocked stn-1-up) (blocked stn-2-up) (blocked stn-3-up)))
 )

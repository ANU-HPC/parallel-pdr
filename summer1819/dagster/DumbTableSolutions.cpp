...
void DumbTableSolutions::register_message_completion(Message* m) {
...
int** DumbTableSolutions::get_additional_clauses(int node) {
...
DumbTableSolutions::~DumbTableSolutions() {
...
DumbTableSolutions::DumbTableSolutions(Dag *new_dag) : WrappedSolutionsInterface(new_dag) {
  if (new_dag == NULL)
...
void DumbTableSolutions::add_message(Message* m) {
...
bool DumbTableSolutions::_get_combination(
  int dst, 
...
Message *DumbTableSolutions::get_new_message_combination(int depth) {

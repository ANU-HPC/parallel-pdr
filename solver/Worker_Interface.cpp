...
int Worker_Interface::get_lowest_layer_for_initial_state() {
  if (Global::problem.MPI_active) return _distributed_worker_interface->get_lowest_layer_for_initial_state();
  else                            return _serial_worker_interface->get_lowest_layer_for_initial_state();
}

...
class Strategies {
  ...
  private:
    ...
    void add_goal_to_layer_object();
    void reset_and_push(const unordered_set<Contextless_Reason, Contextless_Reason_Hash>& all_reasons_layer_1, int k, int layer_to_push_out_to);
    unordered_set<Contextless_Reason, Contextless_Reason_Hash> trim_to_and_add_valid(const unordered_set<Contextless_Reason, Contextless_Reason_Hash>& reasons);
    unordered_set<Contextless_Reason, Contextless_Reason_Hash> get_all_reasons_layer_1(int k);
